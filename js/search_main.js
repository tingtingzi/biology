...
SEARCH.util = {
    ...
    bind_attr_href: function(a, b) {
        var d = this,
        c = typeof(MS.selected_attr) == "undefined" ? $("#select,#filter") : $("#filter");
...
$.extend({
    ...
    function() {
        if (!$(this).attr("s") || $(this).attr("s") == null || $(this).attr("s") == "1") {
            $(this).html("<span>收起</span><b class='close'></b>").attr({
                s: "0"
            });
            a(true)
        } else {
            $(this).html("<span>显示全部分类</span><b class='open'></b>").attr({
                s: "1"
            });
            a(false)
        }
...
window.searchlog = function() {
    ...
    var b = "http://sstat.jd.com/scslog?args=",
    c = k.length,
    l;
    if (c > 0) {
        if (k[0] == 0) {
...
GS.init = function() {
    ...
    var c = "";
    for (var b = 0,
    a = this.collocation[3].length; b < a; b++) {
    ...
    c = "";
    for (var b = 0,
    a = this.collocation[2].length; b < a; b++) {
    ...
    this.obj.children("a").bind("mouseenter",
    function() {
        if (GS.delytime) {
    ...
    function() {
        ...
        500)
    }).next("div.prompt").bind("mouseenter",
    function() {
        clearTimeout(GS.delytime)
    }).bind("mouseleave",
    function() {
...
GS.html = function(a, c) {
    c = c === 0 ? 1 : 0;
    var e = "",
    g, h = this.obj.find("dl:eq(" + c + ")"),
    f = h.find("a.curr").html();
    for (var d = 0,
    b = a.length; d < b; d++) {
        if (f == a[d]) {
            g = "curr"
...
GS.search = function() {
    var a, b = this.obj.find("dl:eq(0) a.curr").html(),
    c = this.obj.find("dl:eq(1) a.curr").html();
    if (b && c) {
        a = "送" + b + c + "礼物"
    } else {
        if (b) {
...
SEARCH.track_iframe_onebox = function() {
    var c = this,
    b = /^http\:\/\/(.*)\.(jd|360buy)\.com/i,
    a = [];
    $(".J_oneBoxFrame").each(function() {
        var d, e = $(this).attr("src") || $(this).attr("data-src");
        if (b.test(e)) {
            d = RegExp.$1;
            if (d == "life" && e.indexOf("initRestaurant") > -1) {
                d = "dingzuo"
            } else {
                if (d == "life" && e.indexOf("initTakeOut") > -1) {
                    d = "waimai"
                }
            }
            a.push(d) && c.iframe_click.track($(this)[0],
            function() {
                searchlog(1, 0, 0, 59, d)
            })
        }
    });
    if ($("#shopboxIFrame").length) {
        c.iframe_click.track(document.getElementById("shopboxIFrame"),
        function() {
            searchlog(1, 0, 0, 58, "", "shopADClk=1")
        })
    }
    return a.join("$")
};
...
SEARCH.get_book_summary = {
    ...
    dataUrl: "http://d.jd.com/bookExt/get?skuId=",
    edataUrl: "http://e.jd.com/ebook/ExteBookService.aspx?stype=search&skuid=",
    setPosition: function(a) {
        var c = $(a.get(0)).position(),
        b = window.pageConfig.wideVersion ? 360 : 120;
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            if (!a) {
                ...
                f.find(".shop-sname a:eq(0)").html(e.name).attr({
                    title: e.title,
                    href: e.url
                }).parent().show();
...
SEARCH.get_im_info = function(a, b) {
    ...
    $.ajax({
        ...
        success: function(m) {
            ...
            var d = {},
            e = $("#store-selector").find(".text").text(),
            f = function(u, t, i) {
...
SEARCH.get_shop_name = function() {
    var e = this,
    c = $("#plist").find("div.service,div.shop-name").not('[done="1"]').filter("[shop_id]"),
    d = c.length;
    if (!d) {
        return false
    }
    ...
    function(n) {
        ...
        var f = {},
        g = [],
        m = $("#plist").find("ul.list-h").attr("tpl");
        for (var k = 0,
        h = n.length; k < h; k++) {
            f[n[k].id] = n[k]
        }
...
SEARCH.bind_events = {
    iplocation: (function(e, k) {
        ...
        var n = '<div data-widget="tabs" class="m JD-stock" id="JD-stock"><div class="mt">    <ul class="tab">        
        ...
        <ul class="area-list">       
        <li>
        <a href="javascript:;" data-value="1">北京</a></li><li><a href="javascript:;" data-value="2">上海</a></li><li><a href="javascript:;" data-value="3">天津</a></li><li><a href="javascript:;" data-value="4">重庆</a></li><li><a href="javascript:;" data-value="5">河北</a></li><li><a href="javascript:;" data-value="6">山西</a></li><li><a href="javascript:;" data-value="7">河南</a></li><li><a href="javascript:;" data-value="8">辽宁</a></li><li><a href="javascript:;" data-value="9">吉林</a></li><li><a href="javascript:;" data-value="10">黑龙江</a></li><li><a href="javascript:;" data-value="11">内蒙古</a></li><li><a href="javascript:;" data-value="12">江苏</a></li><li><a href="javascript:;" data-value="13">山东</a></li><li><a href="javascript:;" data-value="14">安徽</a></li><li><a href="javascript:;" data-value="15">浙江</a></li><li><a href="javascript:;" data-value="16">福建</a></li><li><a href="javascript:;" data-value="17">湖北</a></li><li><a href="javascript:;" data-value="18">湖南</a></li><li><a href="javascript:;" data-value="19">广东</a></li><li><a href="javascript:;" data-value="20">广西</a></li><li><a href="javascript:;" data-value="21">江西</a></li><li><a href="javascript:;" data-value="22">四川</a></li><li><a href="javascript:;" data-value="23">海南</a></li><li><a href="javascript:;" data-value="24">贵州</a></li><li><a href="javascript:;" data-value="25">云南</a></li><li><a href="javascript:;" data-value="26">西藏</a></li><li><a href="javascript:;" data-value="27">陕西</a></li><li><a href="javascript:;" data-value="28">甘肃</a></li><li><a href="javascript:;" data-value="29">青海</a></li><li><a href="javascript:;" data-value="30">宁夏</a></li><li><a href="javascript:;" data-value="31">新疆</a></li><li><a href="javascript:;" data-value="32">台湾</a></li><li><a href="javascript:;" data-value="42">香港</a></li><li><a href="javascript:;" data-value="43">澳门</a></li><li><a href="javascript:;" data-value="84">钓鱼岛</a></li>    </ul></div><div class="mc" data-area="1" data-widget="tab-content"></div><div class="mc" data-area="2" data-widget="tab-content"></div><div class="mc" data-area="3" data-widget="tab-content"></div></div><span class="clr"></span>';
        b.children(".content").html(n);
        var g = b.find("li[data-widget]"),
        ...
        return function() {
            ...
            d.click(function(q) {
                f = false;
                var p = e(q.srcElement || q.target),
                o = parseInt(p.attr("data-value"), 10);
                if (!o) {
                    return
                }
    ...
    box_search: function() {
        ...
        $.get("hub.php?keyword=" + encodeURIComponent(QUERY_KEYWORD) + "&enc=utf-8",
        function(b) {
            if (!b) {
                return
            }
    ...
    brandFolded: function() {
        ...
        h = g.find("div.tabcon"),
        i = h.children("div"),
        c = h.hasClass("show-logo"),
        b = window.pageConfig.wideVersion ? c ? 14 : 15 : c ? 10 : 12,
        l = g.find("ul.tab"),
        f = "可搜索拼音、汉字查找品牌",
        d = false,
        e;
    ...
    handle_more_multi: function(f) {
        ...
        if (!f) {
            var d = $("#select").find("div.brand-attr"),
            e,
            c,
            b;
            if (d.length) {
    ...
    viewTypeSelect: function() {
        var a = window.SEARCH;
        a.view_type = 2;
        if ($("#list-unselected").hasClass("list-curr")) {
            a.view_type = 1
        } else {
...
SEARCH.page = function(b, a) {
    ...
    window.location.hash = this.base_url + "&psort=" + this.psort + "&page=" + b;
    if (a) {
...
SEARCH.page_jump = function(b, a) {
    ...
    return a ? this.page(2 * c - 1, true) : this.page(c, true),
    false
};
SEARCH.sort_html = function(c) {
    ...
    var b = "<dt>排序：</dt>",
    a = '<dd class="#class#"><a href="javascript:;" onclick="#click#">#name#</a><b></b></dd>',
    d = class_name = "";
    if (c == "") {
        class_name = "curr"
    } else {
...
SEARCH.load = function(b, a) {
    ...
    var f = this,
    e = $("#plist"),
    d = f.util.getQueryString("click", b),
    c = a ? 1 : d == f.click ? 2 : 3;
    if (c == 3) {
    ...
    $.ajax({
        ...
        success: function(h) {
            if (c == 1) {
                ...
                if (c == 2) {
                    e.children().not(".m-tipbox,ul.J_diviner").remove();
                    e.prepend(h)
                } else {
                    $(".right-extra").html(h);
                    f.bind_events.init();
...
MS.attr_click = function(h, c, o) {
    var i = $(h).parents(".attr");
    if (i.hasClass("attr-select")) {
        ...
        var l, g, j = $(h),
        m = j.parents(".attr").parent();
        this.selected_attr = this.selected_attr || [0, {}];
        if (m.attr("class") == "color-attr") {
            l = j;
            g = "curr"
        } else {
            l = j.parent();
        ...
        q = f.left - 50,
        n = f.top - 26;
        var b = $('<span id="max-notice" style="position:absolute;left:' + q + "px;top:" + n + 'px;z-index:100;border:1px solid #EDD28B;background:#FFFDEE;">已超过可选选项个数最大值喽！</span>');
        if (l.hasClass(g)) {
            this.selected_attr[0]--;
            l.removeClass(g);
            if (j.parent().attr("rel")) {
                $("div.s-brands a").each(function() {
                    if ($(this).attr("title") == j.attr("title")) {
                        $(this).remove();
                        return false
                    }
                })
            ...
            if (this.selected_attr[0] >= 5) {
                ...
                this.selected_attr[0]++;
                l.addClass(g);
                if (j.parent().attr("rel") && (j.parent().siblings().length > (window.pageConfig.wideVersion ? 30 : 24))) {
                    var a = '<a href="' + j.attr("href") + '" icon="' + j.parent().attr("id") + '" title="' + j.attr("title") + '" onclick="MS.selected_brand_click(this);return false;" data="' + c + '">' + j.text() + "</a>";
                    $("div.s-brands").css("display", "block").find(".dd").append(a)
                }
                this.selected_attr[1][c] = this.get_last_attr(SEARCH.util.getQueryString("ev", j.attr("href")))
            }
        }
        this.submit_style(m);
        ...
        if (d - this.interval_time > 800) {
            $.get("WareCount.php?" + this.submit_url(), (function(e) {
                return function(p) {
                    ...
                    MS.LastModified = e;
                    b.html("当前选择条件下，约有" + p + "个" + SEARCH.search_type).prependTo("body");
                    setTimeout(function() {
                        b.animate({
                            opacity: 0
                        },
        ...
        searchlog(1, 0, $("#select>.attrs").children().not(".selected-c").find(".attr").index(i) * 10000 + o, 71, c)
    }
};
...
MS.submit_url = function() {
    ...
    d = "",
    c = window.SEARCH,
    b = c.util.filtUrl(c.base_url, "click");
    ...
    a.fn.imgScroll = function(b, e) {
        ...
        return this.each(function() {
            ...
            o = null,
            k = null,
            j = typeof c.next == "string" ? a(c.next) : c.next,
            h = typeof c.prev == "string" ? a(c.prev) : c.prev,
            y = 0,
            p = c.step,
            i = c.visible,
            G = Math.ceil((D - i) / p) + 1,
            ...
            w = c.evtType,
            n = c.disableClass,
            E = c.disableClassPerfix ? "prev-" + n: n,
            F = c.disableClassPerfix ? "next-" + n: n,
            r = c.navItems,
            A = c.navItmesWrapClass,
            u = c.navItemActivedClass,
            t = false,
            q = true,
            C = (D - i) % p == 0;
            function B(H) {
            ...
            function m(H, I) {
                ...
                v.animate(x == "x" ? {
                    left: H >= (G - 1) ? -(D - i) * o: -H * p * o
                }: {
                    top: H >= (G - 1) ? -(D - i) * k: -H * p * k
                },
                b.speed,
                function() {
                    if (D - H * p <= i) {
...
SEARCH.image_scroll = function(a) {
    ...
    $(a).each(function() {
        var d = $(this).find(".p-scroll-wrap"),
        f = $(this).find(".p-scroll-prev"),
        ...
        d.find("img").each(function() {
            $(this).mouseover(function() {
                var k = $(this).attr("src"),
                l = $(this).attr("data-skuid");
                d.find("a").removeClass("curr");
                $(this).parent("a").addClass("curr");
                var j = $(this).parents("li").find(".p-img img").eq(0),
                i = $(this).parents("li").find(".p-img a").eq(0),
                h = $(this).parents("li").find(".p-name a").eq(0),
...
SEARCH.get_digital_price = function(b, a) {
    $.getJSON("http://p.3.cn/prices/mgets?skuids=" + b + "&area=" + a.replace(/-/g, "_") + "&type=1&callback=?",
    function(c) {
        SEARCH.set_digital_price_data(c)
    })
};
SEARCH.get_ware_stock = function(b, a) {
    $.getJSON("http://search.jd.com/stock?skus=" + b.replace(/J_/g, "") + "&district=" + a.split("-").slice(0, 3).join("_") + "&callback=?",
    function(c) {
        SEARCH.set_ware_stock_data(c)
    })
};
SEARCH.get_prompt_adwords = function(a) {
    $.getJSON("http://ad.3.cn/ads/mgets?skuids=" + a.replace(/J_/g, "AD_") + "&callback=?",
    function(b) {
        SEARCH.set_prompt_adwords_data(b)
    })
};
SEARCH.get_prompt_flag = function(a) {
    $.getJSON("http://pf.3.cn/flags/mgets?skuids=" + a + "&callback=?",
    function(b) {
        SEARCH.set_prompt_flag_data(b)
    })
};
SEARCH.get_comment_nums = function(a) {
    $.getJSON("http://club.jd.com/clubservice/summary-m-" + a.replace(/J_/g, "") + ".html?callback=?",
    function(b) {
        SEARCH.set_comment_nums_data(b)
    })
};
SEARCH.get_presale_info = function() {
    ...
    var d = $("#plist"),
    b = d.find('a[presale="1"]').not('[p-done="1"]');
    ...
    var f = d.find("ul.list-h").attr("tpl") == "1",
    e = false,
    a = function(h, g) {
        h = h.toString();
    ...
    b.each(function() {
        ...
        var h = $(this).parents("li"),
        g = h.attr("sku");
        if (!g) {
            return false
        }
        $.getJSON("http://soa.yushou.jd.com/yushoulistinfo.action?sku=" + g + "&callback=?",
        function(o) {
            ...
            if (q.t == "2" && q.sa) {
                var k = '<div clstag="" class="sp-stage clearfix">',
                r;
                for (var p = 0,
                m = q.sa.length; p < m; p++) {
                    r = "";
...
SEARCH.get_ware_info = function() {
    ...
    if (this.enable_merge_request) {
        ...
        this.get_digital_price(b, a),
        this.get_ware_stock(b, a),
        this.get_prompt_adwords(b),
        this.get_prompt_flag(b),
        this.get_comment_nums(b)
    }
    this.get_shop_name(),
    this.digital_music_summmary(),
    this.get_book_summary.init(),
    this.get_presale_info()
};
...
SEARCH.set_prompt_adwords_data = function(d) {
    ...
    a = d.length; c < a; c++) {
        var f = d[c].id || "",
        e = $("#" + f),
        b = SEARCH.util.strip_tags(d[c].ad);
        if (e.length && b !== "") {
...
SEARCH.set_comment_nums_data = function(d) {
    if (typeof(d) != "object" || typeof(d.CommentsCount) != "object") {
        return false
    }
    for (var c = 0,
    b = d.CommentsCount,
    a = b.length; c < a; c++) {
        if (typeof(b[c].CommentCount) != "undefined") {
            ...
            $("#star-" + b[c].SkuId).attr("class", "star-yellow h" + b[c].AverageScore)
        }
    }
};
SEARCH.set_ware_stock_data = function(n) {
    ...
    var a = $("a[stock]"),
    k = readCookie("ipLoc-djd") || "",
    j = k.split("-"),
    e = j[0] ? window.json_city[0][j[0]] : "",
    g = [];
    for (var h = 0,
    c = a.length; h < c; h++) {
        var p = a.eq(h),
        ...
        case 34:
            ...
            if (p.attr("data-disable-notice") == "1") {
                ...
                var f = SEARCH.util.get_ware_type(o); (f == "book" || f == "mvd") && g.push(o)
            }
            break;
        case 36:
    ...
    $.getJSON("WareStock.php?wids=" + g.join(","),
    function(q) {
        if (typeof q != "object") {
            return
        }
...
SEARCH.get_ware_info_merge = function(e, c) {
    var b = e.replace(/J_/g, ""),
    f = this;
    for (var d = 1,
    a = f.apiArray.length - 1; d <= a; d = d * 2) {
    ...
    setTimeout(function() {
        for (var j = 1,
        h, g = f.apiArray.length - 1; j <= g; j = j * 2) {
...
SEARCH.jsonpcallback = function(c, e) {
    for (var d = 1,
    b, a = SEARCH.apiArray.length - 1; d <= a; d = d * 2) {
...
SEARCH.get_baby_info = function() {
    ...
    function d(p) {
        ...
        o = p < b ? p: b;
        n = p < b ? b: p;
        var r = n.getYear() - o.getYear(),
        k = n.getMonth() - o.getMonth(),
        q = n.getDate() - o.getDate();
        if (q < 0) {
            q += 30;
            k -= 1
        }
    ...
    $.ajax({
        url: "http://uprofile.jd.com/u/baby/getinfo?callback=?",
        async: true,
        dataType: "jsonp",
        success: function(l) {
    ...
    j.find(".btn-submit").click(function() {
        ...
        $.getJSON("http://passport.jd.com/loginservice.aspx?method=Login&callback=?",
        function(l) {
...
SEARCH.get_paipai_ware = function() {
    var c = this,
    b = encodeURIComponent(QUERY_KEYWORD),
    a = "http://se.paipai.com/comm_search?KeyWord=" + b + "&charSet=gbk&PTAG=12468.2.6";
    $.ajax({
        url: "http://sse1.paipai.com/comm_json?charset=utf-8&dtype=jsonp&dtag=search&KeyWord=" + b + "&PageSize=5&ShowClass=1&jdreqtype=1",
        dataType: "jsonp",
        scriptCharset: "utf-8",
        success: function(g) {
            if (typeof(g) != "object" || g.JDShowItemFlag == "false") {
                return
            }
            var f = '<div class="m m0 paipai-result"><div class="mt"><h2 class="paipai"><i></i>为您在拍拍找到如下结果</h2></div>';
            f += '<div class="mc"><div class="paipai-showall"><strong>' + c.util.htmlspecialchars(QUERY_KEYWORD) + "</strong>";
            f += "共" + g.data.totalNum + '个商品<a target="_blank" href="' + a + '" onclick="log(\'paipai\',\'normal-clk-all\',QUERY_KEYWORD)">查看全部</a></div><ul class="lh">';
            for (var e = 0,
            d = g.data.list.length; e < d; e++) {
                var l = g.data.list[e],
                m = c.util.strip_tags(l.title),
                k = l.link + (l.link.indexOf("?") > -1 ? "&": "?") + "PTAG=12468.2." + (e + 1),
                h = " onclick=\"log('paipai','normal-clk',QUERY_KEYWORD,'" + e + "', '" + l.link + "'); JA.tracker.ngloader('search.000003', {logid:LogParm.log_id,logtype:1,key:QUERY_KEYWORD,reco_type:'pp',result_count:" + d + ",pos:" + e + '})"';
                f += '<li><div class="p-img"><a target="_blank" title="' + m + '" href="' + k + '"' + h + '><img height="130" width="130" alt="" src="' + l.img160 + '"></a></div>';
                f += '<div class="p-name"><a target="_blank" title="' + m + '" href="' + k + '"' + h + ">" + l.title.replace(/<em>(.+?)<\/em>/g, '<font class="skcolor_ljg">$1</font>') + "</a></div>";
                f += '<div class="p-comm"><a target="_blank" href="' + k + '#salesrecords"' + h + ">(销售数量" + l.saleNum + ")</a></div>";
                f += '<div class="p-price"><strong>￥' + l.price + "</strong></div></li>"
            }
            f += "</ul></div></div>";
            $("#bottom_pager").after(f);
            log("paipai", "normal-show", QUERY_KEYWORD, g.data.totalNum, g.data.list.length, window.location.href);
            c.util.ngloader("search.000003", {
...
SEARCH.get_diviner_ware = function(g) {
    var b = [],
    f = this,
    c = $("#plist"),
    a = readCookie("ipLoc-djd") || "",
    e = a.split("-"),
    d = e[0] ? window.json_city[0][e[0]] : "";
    c.find('strong[class^="J_"]').slice(0, 4).each(function() {
        b.push(this.className.substr(2))
    });
    $.ajax({
        url: "http://diviner.jd.com/diviner?p=907006&skus=" + b.join(",") + "&uuid=&pin=" + (readCookie("pin") || "") + "&c3=" + g + "&lid=" + e[0] + "&lim=8&ec=utf-8",
        dataType: "jsonp",
        success: function(s) {
            if (typeof(s) != "object" || !s.success) {
                return
            }
            var k = '<div class="m-tipbox"><div class="tip-inner"><div class="tip-text">根据上面的商品结果，为您推荐的相似商品。</div></div></div><ul class="list-h clearfix J_diviner">',
            p = c.find("ul.list-h").attr("tpl"),
            q,
            l = function(j) {
                var i = new Image();
                j = j + "&m=UA-J2011-1&ref=" + encodeURIComponent(document.referrer) + "&random=" + Math.random();
                i.setAttribute("src", j)
            };
            if (p == "1") {
                q = '<li sku="{#sku#}" data-clk="{#clk#}" data-pos="{#pos#}"><div class="lh-wrap"><div class="p-img"><a target="_blank" href="http://item.jd.com/{#sku#}.html"><img width="220" height="220" data-img="1" data-lazyload="http://img1{#index#}.360buyimg.com/n7/{#img#}" /></a><div shop_id="0"></div></div>';
                q += '<div class="p-name"><a target="_blank" href="http://item.jd.com/{#sku#}.html">{#t#}<font class="adwords" id="AD_{#sku#}"></font></a></div>';
                q += '<div class="p-price"><em></em><strong class="J_{#sku#}">￥{#jp#}</strong><span id="p{#sku#}"></span></div>';
                q += '<div class="extra"><span class="star"><span class="star-white"><span id="star-{#sku#}" class="star-yellow h5">&nbsp;</span></span></span><a id="comment-{#sku#}" target="_blank" href="http://item.jd.com/{#sku#}.html#comments-list">已有人评价</a></div>';
                q += '<div class="stocklist"><span class="st33">' + d + "有货</span></div>";
                q += '<div class="btns"><a stock="{#sku#}" href="http://gate.jd.com/InitCart.aspx?pid={#sku#}&pcount=1&ptype=1" target="_blank" class="btn-buy">加入购物车</a><a id="coll{#sku#}" class="btn-coll">关注</a>{#compare#}</div>';
                q += '<div class="p-phone"></div></div></li>'
            } else {
                if (p == "2") {
                    q = '<li class="item-book" bookid="{#sku#}" data-clk="{#clk#}" data-pos="{#pos#}"><div class="p-img"><a target="_blank" href="http://item.jd.com/{#sku#}.html"><img width="160" height="160" data-img="1" data-lazyload="http://img1{#index#}.360buyimg.com/n2/{#img#}" /></a><div shop_id="0"></div></div>';
                    q += '<div class="p-name"><a target="_blank" href="http://item.jd.com/{#sku#}.html">{#t#}<font class="adwords" id="AD_{#sku#}"></font></a></div>';
                    q += '<div class="p-info"></div>';
                    q += '<div class="p-price"><i>京东价：</i><strong class="J_{#sku#}">￥{#jp#}</strong><span class="discount"></span><span id="p{#sku#}"></span></div>';
                    q += '<div class="stocklist"><span class="st33">' + d + "有货</span></div>";
                    q += '<div class="service">由{#shop#}发货</div>';
                    q += '<div class="extra"><span class="star"><span class="star-white"><span id="star-{#sku#}" class="star-yellow h5">&nbsp;</span></span></span><a id="comment-{#sku#}" target="_blank" href="http://item.jd.com/{#sku#}.html#comments-list">已有人评价</a></div>';
                    q += '<div class="p-summary" id="summary-{#sku#}"><span></span></div>';
                    q += '<div class="btns"><a stock="{#sku#}" href="http://gate.jd.com/InitCart.aspx?pid={#sku#}&pcount=1&ptype=1" target="_blank" class="btn-buy">加入购物车</a><a id="coll{#sku#}" class="btn-coll">关注</a></div>';
                    q += '<div class="p-shopnum pop-seller"></div></li>'
                } else {
                    if (p == "3") {
                        if (c.hasClass("plist-n8")) {
                            var h = 220,
                            r = 282,
                            t = 8
                        } else {
                            if (c.hasClass("plist-n2")) {
                                var h = 160,
                                r = 160,
                                t = 2
                            } else {
                        ...
                        q = '<li sku="{#sku#}" data-clk="{#clk#}" data-pos="{#pos#}"><div class="lh-wrap"><div class="p-img"><a target="_blank" href="http://item.jd.com/{#sku#}.html"><img width="' + h + '" height="' + r + '" data-img="1" data-lazyload="http://img1{#index#}.360buyimg.com/n' + t + '/{#img#}" /></a><div shop_id="0"></div></div>';
                        q += '<div class="p-scroll"><a href="javascript:;" class="p-scroll-btn p-scroll-prev">&lt;</a><div class="p-scroll-wrap"><ul><li><a href="javascript:;" class="curr"><img data-skuid="{#sku#}" width="25" height="25" data-lazyload="http://img1{#index#}.360buyimg.com/n9/{#img#}" /></a></li></ul></div><a href="javascript:;" class="p-scroll-btn p-scroll-next">&gt;</a></div>';
                        q += '<div class="p-name"><a target="_blank" href="http://item.jd.com/{#sku#}.html">{#t#}<font style="color:#ff0000" class="adwords" id="AD_{#sku#}"></font></a></div>';
                        q += '<div class="p-price"><em></em><strong class="J_{#sku#}">￥{#jp#}</strong><span id="p{#sku#}"></span></div>';
                        q += '<div class="extra"><span class="star"><span class="star-white"><span id="star-{#sku#}" class="star-yellow h5">&nbsp;</span></span></span><a id="comment-{#sku#}" target="_blank" href="http://item.jd.com/{#sku#}.html#comments-list">已有人评价</a></div>';
                        q += '<div class="stocklist"><span class="st33">' + d + "有货</span></div>";
                        q += '<div class="hide"><a stock="{#sku#}"></a></div>';
                        q += '<div class="product-follow"><a href="javascript:;" class="btn-coll" id="coll{#sku#}"><s></s>加关注</a></div></div></li>'
                    }
                }
            }
            for (var o = 0,
            m = s.data.length; o < m; o++) {
                var n = s.data[o];
                n.index = n.sku % 5;
                n.pos = o;
                if (p == "1") {
                    n.compare = String(n.sku).length == 8 ? "": '<a class="btn-compare btn-compare-s" id="comp_' + n.sku + '" skuid="' + n.sku + '"><span></span>对比</a>'
                } else {
                    if (p == "2") {
                        n.shop = String(n.sku).length == 10 ? " 第三方商家 ": " 京东 "
                    }
                }
                k += f.util.template(q, n)
            }
            c.append(k + "</ul>");
            pageConfig.FN_ImgError(document);
            c.find("img[data-lazyload]").Jlazyload({
                type: "image",
                placeholderClass: "err-product"
            });
            f.get_ware_info();
            f.image_scroll('#plist li:not([done="1"]) .p-scroll');
            pageConfig.isInitContrast = false;
            pageConfig.FN_InitContrast();
            c.find("ul.J_diviner>li").click(function(j) {
                var u = $(this),
                i = j.target.nodeName;
                if ((i == "A" || i == "IMG") && !$(j.target).parents(".p-scroll").length || i == "FONT") {
                    l(u.attr("data-clk"));
...
SEARCH.get_adv_info = function(f, d, c, b, e) {
    var g = this,
    a = encodeURIComponent(window.REAL_KEYWORD || window.QUERY_KEYWORD);
    $.ajax({
...
SEARCH.init = function(page, total_page, result_count, sort, scroll, shop_id, cid, survey_html, recommend) {
    this.get_ware_info(),
    this.get_shop_info(shop_id),
    this.get_multi_shops(),
    this.bind_events.init(),
    this.relate_search.init(),
    this.top_page_html(page, total_page, result_count, scroll),
    this.bottom_page_html(page, total_page, scroll),
    this.sort_html(sort),
    this.image_scroll('#plist li:not([done="1"]) .p-scroll'),
    (recommend & 1) == 1 && this.get_diviner_ware(cid),
    (recommend & 2) == 2 && this.get_paipai_ware();
    $.delayLoad(true, "script/digital_music_download.js?100.js", "utf-8", "", 'li[e-tag!="1"] a.free-download');
    $.ajax({
...
$(window).scroll(function() {
    ...
    $.ajax({
        url: "http://nfa.jd.com/loadFa_toJson.js?aid=" + b.join("-") + "&ver=20140526",
        dataType: "script",
        cache: true,
        success: function() {
